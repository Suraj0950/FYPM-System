...
export const forgotPassword = createAsyncThunk("auth/passoword/forgot",
...
export const getUser = createAsyncThunk("auth/me",
  async ( _, thunkAPI) => {
  try {
...
export const logout = createAsyncThunk("auth/logout",
  ...
  try {
    ...
    return thunkAPI.rejectWithValue(
      error.response.data.message || "Failed to fetch logout"
    );
  }
});
